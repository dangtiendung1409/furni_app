...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  // Thêm biến để lưu thông báo lỗi
  String? errorMessage;
              ...
              children: [
                ...
                Column(
                  children: [
                    PrimaryButton(
                      onTap: () async {
                        // Reset thông báo lỗi trước khi gọi đăng ký
                        setState(() {
                          errorMessage = null;
                        });

                        try {
                          // Gọi phương thức đăng ký và truyền context
                          ...
                          setState(() {
                            errorMessage =
                                'Email already exists'; // Cập nhật thông báo lỗi
                          });
                        }
                      },
                      text: 'Create Account',
